    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="index2.html" class="logo">
          ...
          <span class="logo-lg"><b>Biro</b> Umum</span>
        </a>
      ...
      <aside class="main-sidebar">
        ...
        <section class="sidebar">
          ...
          ?>
	           ...
	           <?php
                        $main=$this->db->get_where('ms_menu_admin',array('parent'=>0))->result();
                        foreach ($main as $m ){
                            // chek ada submenu atau tidak
                            $sub=$this->db->get_where('ms_menu_admin',array('parent'=>$m->id));
                            if($sub->num_rows()>0){
                                // looping submenu
                                echo "<li class='treeview'>";
                                echo anchor('#', ' <i class="fa '.$m->icon.'"></i> <span>'.strtoupper($m->nama).'</span> <i class="fa fa-angle-left pull-right"></i>');
                                echo "<ul class='treeview-menu'>";
                                foreach ($sub->result() as $s){
                                    echo '<li>'.anchor($s->link,' <i class="fa '.$s->icon.'"></i> <span>'.strtoupper($s->nama)).'</span></li>'; 
                                }
                                echo "</ul>";
                                echo "</li>";
                            }else{
                                echo '<li>'.anchor($m->link,' <i class="fa '.$m->icon.'"></i> <span>'.strtoupper($m->nama)).'</span></li>';
                            }
                        }?>
          </ul>
        </section>
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
        	<i class="fa fa-home"></i>
        	  <a target="_blank" href="<?php echo base_url() ?>">Open website</a>
        </section>
        <!-- Main content -->
      ...
      <footer class="main-footer">
        ...
        <strong>Bakwan-Production &copy; 2015 <a href="http://bakwan.com">bakwan</a>.</strong> All rights reserved.
      </footer>
