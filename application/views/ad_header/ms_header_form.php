...
<div class="col-lg-12">
            ...
            <div class="ibox-title">
                <h5>Ms_header <?php echo $button ?></h5>
	    ...
	    <div class="form-group">
            <label for="varchar">Nama Website <?php echo form_error('nama') ?></label>
	    ...
	    <a href="<?php echo site_url('ad_header') ?>" class="btn btn-default">Cancel</a>
	</form>
</div>
</div>
</div>
