        ...
        <div style="min-height: 400px;padding: 20px;font-size: 14px">
            ...
            <tr>
                ...
                <tr>
                    ...
                    <td>:</td>
                    <td><b><img src="<?php echo base_url().'upload/asset/'. $pesanan['full_foto']?>" alt="150" width="350" height="400"/></td>
                </tr>
                <tr>
                    <td style="padding-left: 20px;">pas foto</td>
                    <td>:</td>
                    <td><b><?php echo $pesanan['pas_foto'] ?><img src="<?php echo base_url().'upload/asset/'. $pesanan['pas_foto']?>" alt="150" width="350" height="400"/></td>
                </tr>
                <tr>
