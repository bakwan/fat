...
class Model_ad_header extends CI_Model
{

    public $table = 'ms_header';
    public $id = 'id';
    public $order = 'DESC';
...
/* End of file Model_ad_header.php */
/* Location: ./application/models/Model_ad_header.php */
